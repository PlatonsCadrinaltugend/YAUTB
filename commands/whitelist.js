exports.execute = {
    name:"whitelist",
    code:(async function whitelist(args, standartargs){
		...
		if (args.message != null && (args.usernameSender == args.originChannel || args.usernameSender =="deadcr1")){
            ...
            if (username) {
                ...
                standartargs.whitelist_obj = whitelist.saveWhitelist(userId, args.originChannel, username, false, standartargs.socket, args.originChannelID, standartargs.whitelist_obj);
            }}
        return standartargs;
    })
}